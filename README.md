...
**Phe ve** is a Ruby on Rails application that allows users to create and buy tickets to cool events.
...
* [x] 10 model tests, 2 route tests, 2 controller tests, No view tests.
